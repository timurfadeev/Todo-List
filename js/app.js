...
(function (arrOfTasks) {
  ...
  let setThemeDefault = localStorage.getItem("app_theme") || "default";
  ...
  function themeSelectHandler(e) {
    ...
    const isConfirm = confirm(
      `Вы точно хотите сменить тему на ${selectedTheme}?`
    );
    if (!isConfirm) {
      themeSelect.value = setThemeDefault;
      return;
    }
    setTheme(selectedTheme);
    setThemeDefault = selectedTheme;
